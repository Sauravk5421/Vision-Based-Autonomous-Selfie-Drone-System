...
public class Imgproc {
    ...
    public static void HoughLinesP(Mat image, Mat lines, int houghGradient, int i1, int i, double v, double rho, double theta, int threshold)
    {
    ...
    public static void Canny(Mat image, Mat edges, int i, double threshold1, double threshold2)
    {
